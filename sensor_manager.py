...
class SensorManager:
    ...
    def read_sensors(self):
        ...
        self.filter.filter_data(self.altitude, self.acceleration_acce_x, self.acceleration_acce_z, self.acceleration_acce_y, self.eulerangle_imu_y,self.eulerangle_imu_z)
