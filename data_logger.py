...
class DataLogger:
    def __init__(self, name: str, accelerometer: sensors.Accelerometer, altimeter: sensors.Altimeter, imu: sensors.IMU):
        self.name = name
    ...
    def log_sensors(self):
        ...
        self.data_filter.filter_data(altitude, acceleration_acce_z, linacceleration_imu_z, eulerangle_imu_z)
        kalman_acceleration = self.data_filter.kalman_acceleration
        kalman_velocity = self.data_filter.kalman_velocity
        kalman_altitude = self.data_filter.kalman_altitude
        orientation_beta = self.data_filter.orientation_beta
